...
//					System.out.println("Liczba tokenow: " + st.countTokens());
					...
					case 3:
						...
						if (odpowiedz.equals("TAK"))
							...
							System.out.println("B³êdna odpowiedz");
						break;
					case 4:
						setIDkarty(st.nextToken());
		...
		// parsuj contontent i zapisz do 4 zmiennych: IDkarty; Kwota;
		// Poprzednia_kwota; PIN
	...
	protected void setup()
	{
		...
		{ // przepytaj bankomaty - DF services
			...
			// TODO wyslij zapytanie do bankomatow: Czy ID#### wyplacal u was
			...
			public void action()
			{
						...
						&& msg_wyplata.getPerformative() == ACLMessage.REQUEST)
				{
					...
					System.out.println("Poprzednia kwota to:"
							+ getPoprzednia_kwota());
...
//							System.out.println(bankomat[i]);
							...
							askNeighbors.setContent(msg_wyplata.getContent()); // TODO
																				// zmienic
																				// content
		...
		{ // odpowiedz na zapytanie bankomatu
			...
			public void action()
			{
						...
						&& msg_pytanieBankomatu.getPerformative() == ACLMessage.REQUEST_WHEN)
				{
					...
					replyNeighbor.setContent(msg_pytanieBankomatu.getContent()); // TODO
																					// zmienic
																					// content
																					// -
																					// odpowiedz
...
//							+ iloscBankomatow);
		...
		addBehaviour(new Behaviour() // zachowanie 3 - reakcja na odpowiedz od
										// wszystkich bankomatów
				...
				if (iloscBankomatow == iloscOdpowiedzi)
				{
					...
					System.out
							.println("Wszystkie bankomaty odpowiedzia³y. Iloœæ bankomatów: "
									+ iloscBankomatow);
//					 if (getOdpowiedzTak()==1) // || odpowiedzTak==0 &&
//					 kartaPusta==1)
					{
						autoryzacja = 1;
...
//					 else autoryzacja=-1;
		...
		addBehaviour(new Behaviour() // zachowanie 4 - sprawdzanie odpowiedzi od
		...
		{ //tutaj zliczamy odpowiedzi
			...
			public void action()
			{
						...
						&& msg_rec.getPerformative() == ACLMessage.INFORM)
				{
					...
					{
						// TODO if ktorys bankomat odpowiedzial tak ->
						// odpowiedzTak=1;
					} else if (getOdpowiedzTak() == 1)
					{
						// TODO if kolejny odpowiedzial Tak -> oszustwo ->
						// odpowiedzTak=2;
					}
					iloscOdpowiedzi++;
		...
		addBehaviour(new Behaviour() // zachowanie 5 - wyslanie zapytania do
										// serwera
		...
		addBehaviour(new Behaviour() // zachowanie 6 - reakcja na odpowiedz od
										// serwera
